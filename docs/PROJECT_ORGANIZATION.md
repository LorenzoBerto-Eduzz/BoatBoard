...
BoatBoard/
  project/
    ...
    instance_template/         tracked reusable XLSX/images seed
  scripts/
...
The server creates and reads ignored `project/private_instance/`; that folder contains the complete active instance and must not be committed.
