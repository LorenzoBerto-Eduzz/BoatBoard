...
This is a reusable general project template, not a finished product. It keeps actual source code separate from durable context so work can continue across devices and AI sessions.
